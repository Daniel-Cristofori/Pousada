...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        Funcionario usuario;
        usuario = (Funcionario) FuncionarioDAO.validarUsuario(login, senha);
        ...
        if (usuario != null) {
            ...
            if( usuario.getDepartamento().getNome().equalsIgnoreCase("Gerencia") ) {
                JOptionPane.showMessageDialog(null, "Olá " + usuario.getNome() + ", sua permissão é de " + usuario.getDepartamento().getNome() + ". Seja bem-vindo!");
            }
        ...
        telaInicial.validaUsuario(usuario);
